...
with open('members_dic.pkl', 'rb') as pkl_file:
    country_dic = pickle.load(pkl_file)

'''
Yo Karan, did this work for you?
'''
...
print(f'Country of interest: {country_dic[country_of_interest]}')
print(f'List of years when {country_dic[country_of_interest]} has spoken')
print(years_array.sort_values().values)
...
indices_country_contains = dataset.country.str.contains('CHN')
